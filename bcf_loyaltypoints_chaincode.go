...
func (t *LoyaltyChaincode) Init(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
	...
	t.addProduct(stub, []string{"Speakers", "2000", "200", key2, "500"})
	t.addProduct(stub, []string{"Headphones", "3000", "300", key2, "500"})
	t.addProduct(stub, []string{"Mobile", "4000", "400", key2, "500"})
	t.addProduct(stub, []string{"BagPack", "1000", "100", key2, "500"})
